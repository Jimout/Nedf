...
/** Only mount from `(landing)/layout` — not root layout (keeps App Router context valid). */
export default function CustomCursor() {
  ...
  }, [animate, setCursorPosition, checkHover, enabled, visible])
    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          <circle cx="40" cy="40" r="22" stroke="currentColor" strokeWidth="0.5" opacity="0.25" />
          ...
          <text x="37" y="14" fontSize="3.5" fill="currentColor" opacity="0.5" fontFamily="monospace">
            0°
          </text>
          <text x="37" y="71" fontSize="3.5" fill="currentColor" opacity="0.5" fontFamily="monospace">
            180°
          </text>
          <text x="3" y="41.5" fontSize="3.5" fill="currentColor" opacity="0.5" fontFamily="monospace">
            270°
          </text>
          <text x="65" y="41.5" fontSize="3.5" fill="currentColor" opacity="0.5" fontFamily="monospace">
            90°
          </text>
        </svg>
