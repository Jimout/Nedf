...
export default function SlidingTestimonials() {
  ...
  return (
    <div
      id="testimonials"
      className="relative pt-8 sm:pt-10 md:pt-12 lg:pt-14 xl:pt-16 2xl:pt-20 3xl:pt-24 4xl:pt-28 pb-8 sm:pb-10 md:pb-12 lg:pb-14 xl:pb-16 2xl:pb-20 3xl:pb-24 4xl:pb-28"
    >
      ...
      <div className="relative">
        ...
        >
          <div className={`flex w-[200%] gap-6 sm:gap-6 md:gap-6 xl:gap-8 2xl:gap-14 3xl:gap-16 4xl:gap-20 ${!isDragging && !isHovered ? 'animate-scroll' : ''}`}>
