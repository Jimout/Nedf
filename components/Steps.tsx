...
export default function Steps() {
  ...
  return (
    <div className="w-full max-w-none max-lg:-mt-[18vh] sm:max-lg:-mt-8 md:max-lg:-mt-8 lg:mt-0 max-lg:pt-0 lg:pt-14 xl:pt-16 2xl:pt-20 3xl:pt-24 4xl:pt-28 pb-8 sm:pb-10 md:pb-12 lg:pb-14 xl:pb-16 2xl:pb-20 3xl:pb-24 4xl:pb-28">
