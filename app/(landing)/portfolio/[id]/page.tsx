  ...
  if (!project) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-gray-500 dark:text-white/70 text-lg">Project not found</p>
      </div>
    )
  }
      ...
      >
        ...
        <main className="text-gray-800 dark:text-white relative font-montserrat">
          ...
          <h1 className={`text-4xl font-normal tracking-wide mb-2 ${
            project.title.includes('HIDASSE') || project.title.includes('ARROW') 
              ? 'text-[#001F4B] dark:text-[#ec1e24]' 
              : 'text-[#001F4B] dark:text-white'
          }`}>{project.title}</h1>
          <p className="text-[#001f4b]/70 dark:text-white/70 mb-4">{project.year}</p>
          <hr className="mb-12 border-b-1 border-[#001F4B]/20 dark:border-white/20" />

          {/* Project Info */}
          <div className="space-y-2 text-sm mb-8 leading-relaxed">
            <p className="font-normal text-[#333333] dark:text-white">
              CLIENT: <span className="font-normal text-[#333333]/60 dark:text-white/70">{project.client}</span>
            </p>
            <p className="font-medium text-[#333333] dark:text-white">
              LOCATION: <span className="font-normal text-[#333333]/60 dark:text-white/70">{project.location}</span>
            </p>
            <p className="font-medium text-[#333333] dark:text-white">
              AREA: <span className="font-normal text-[#333333]/60 dark:text-white/70">{project.area}</span>
            </p>
            <p className="font-medium text-[#333333] dark:text-white">
              TOPOLOGY: <span className="font-normal text-[#333333]/60 dark:text-white/70">{project.topology}</span>
            </p>
            <p className="font-medium text-[#333333] dark:text-white">
              ROLE: <span className="font-normal text-[#333333]/60 dark:text-white/70">{project.role}</span>
            </p>
            <p className="font-medium text-[#333333] dark:text-white">
              STATUS: <span className="font-normal text-[#333333]/60 dark:text-white/70">{project.status}</span>
            </p>
          </div>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#333333] dark:text-white mb-6">INSPIRATION</h2>
            <p className="text-[#333333] dark:text-white/70 text-sm font-normal leading-7 text-justify">{project.inspiration}</p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#333333] dark:text-white mb-6">DESCRIPTION</h2>
            <p className="text-[#333333] dark:text-white/70 text-sm font-normal leading-7 text-justify">{project.description}</p>
          </section>
          ...
          >
            <div>
              <p className="text-[#333333] dark:text-white/70 text-sm font-normal leading-7 text-justify">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#333333] dark:text-white mb-6">FEATURES</h2>
            <ul className="list-disc list-inside text-[#333333] dark:text-white/70 text-sm font-normal leading-7 space-y-1">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#333333] dark:text-white mb-6">MATERIALS</h2>
            <ul className="list-disc list-inside text-[#333333] dark:text-white/70 text-sm font-normal leading-7 space-y-1">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-medium text-[#333333] dark:text-white mb-6">COLOR PALETTE</h2>
            <div className="flex gap-6 mb-8">
              {project.colorPalette.map((hex, i) => (
                <div key={i} className="text-center">
                  <div className="w-16 h-16 border" style={{ backgroundColor: hex }} />
                  <p className="text-sm mt-2 text-[#333333] dark:text-white/70">{hex}</p>
                </div>
              ))}
            </div>
          ...
          <motion.section
            ...
            variants={fadeUpVariants}
          >
            <h2 className="text-2xl font-medium text-[#333333] dark:text-white mb-6">LOCATION</h2>
