  ...
  return (
    <div className="space-y-8 p-8 max-w-[1600px] mx-auto">
      <div className="flex flex-col gap-2">
        <h1 className="text-4xl font-bold text-[#001F4B] tracking-tight">Dashboard Overview</h1>
        <p className="text-[#333333]/60 text-base">
            ...
            >
              ...
              <CardContent className="relative pt-7 pb-7 px-6">
                <div className="flex items-start justify-between mb-8">
                  <div
                    className={`${stat.iconBg} ${stat.iconShadow} p-2 rounded-2xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-3`}
                  >
